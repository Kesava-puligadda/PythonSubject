...
Original file is located at
    https://colab.research.google.com/drive/1P3BdEj2_vg09z-Ys9W5IBiOuTJcfwd_z
"""
...
plt.imshow(train_images[0,:,:],cmap='Spectral_r')
...
image_index = 77
plt.imshow(test_data[image_index].reshape(28, 28),cmap='YlOrRd')
